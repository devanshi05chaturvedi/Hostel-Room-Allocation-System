    ...
    <body>
        ...
        <table height='30%' width='10%'>
            <tr align='center' colspan='2'>
                <td>
                    <input class='loginBtn' type="submit" value="Login" name="StudentLogin" />
                </td>
                <td>
                    <input class='loginBtn' type="submit" value="Change Password" name="Changepwd" />
                </td>
...
<%
   if(request.getParameter("StudentLogin")!=null)
    { 
        ...
        String query="select * from student where studentid='"+studentid+"'and studentpwd='"+studentpwd+"'";
//        +"' and pwd='"+pwd+"'"
        ...
        if(status)
        {
            response.sendRedirect("StudentRedirect.jsp");
        }
        else
        {
    ...
    {
        response.sendRedirect("ChangePwdStudent.jsp");
    }
%>
